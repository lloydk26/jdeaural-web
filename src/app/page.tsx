...
export const metadata: Metadata = {
  title: 'JDE Aural Architecture - Engineering Sound, Designing Silence',
  description: 'JDE Aural Architecture delivers innovative acoustical engineering solutions for homes, businesses, and institutions — creating spaces where clarity, comfort, and peace of mind come first.',
};
...
const portfolioSamples = [
  { src: 'https://picsum.photos/600/400?random=1', alt: 'Corporate office space', category: 'Corporate & Commercial', 'data-ai-hint': 'modern office' },
  { src: 'https://picsum.photos/600/400?random=2', alt: 'Hotel lobby', category: 'Hospitality & Residential', 'data-ai-hint': 'hotel lobby' },
  { src: 'https://picsum.photos/600/400?random=3', alt: 'School gymnasium', category: 'Education & Institutions', 'data-ai-hint': 'school gymnasium' },
  { src: 'https://picsum.photos/600/400?random=4', alt: 'Modern chapel', category: 'Worship & Memorial', 'data-ai-hint': 'modern chapel' },
];
